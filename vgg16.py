...
Original file is located at
    https://colab.research.google.com/drive/1fxRKs_yRpC4Jq78HxVLIFBKrOnLKcsDJ
"""
...
def process_pixels(pixels, img_size=IMG_SIZE):
    ...
    input_shape = (64, 64, 1)
    faces = []
    for pixel_sequence in pixels_as_list:
...
def main():
    ...
    raw_data = pd.read_csv('/content/deeplearning/fer2013.csv')
    ...
    # Save Model
    builder = saved_model_builder.SavedModelBuilder("/saveModel")
